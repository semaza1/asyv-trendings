...
export const AddEditVisitorsModal = ({
  open,
  onOpenChange,
  onSubmit,
  initialData,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{initialData ? "Edit" : "Add New"} Visitor</DialogTitle>
          <DialogDescription>
            Fill in the details for your visitor.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter visitor's name or title..."
              required
            />
          </div>
          {/* Category (fixed) */}
          <div className="space-y-2">
            ...
            <Input id="category" value="Visitors" disabled />
          </div>
          {/* Description */}
          <div className="space-y-2">
          ...
          <DialogFooter>
            ...
            <Button type="submit" className="bg-gradient-primary text-white">
              {initialData ? "Update" : "Create"} Visitor
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
...
export default AddEditVisitorsModal;
