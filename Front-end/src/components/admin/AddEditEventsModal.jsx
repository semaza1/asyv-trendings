...
export const AddEditEventsModal = ({
  open,
  onOpenChange,
  onSubmit,
  initialData,
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Combine selected date and time into a single publishDate
    ...
    onSubmit({
      ...
      image: formData.image, // Pass File or string
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{initialData ? "Edit" : "Add New"} Event</DialogTitle>
          <DialogDescription>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Add a link to registration, more info, or external event page
            </p>
          </div>
