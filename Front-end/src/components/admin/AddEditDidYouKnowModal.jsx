...
export const AddEditDidYouKnowModal = ({
  open,
  onOpenChange,
  onSubmit,
  initialData,
  ...
  const [formData, setFormData] = useState({
    title: "",
    description: "",
    category: "Did You Know?", // Set default and fixed category (matches ContentCard)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{initialData ? "Edit" : "Add New"} Fun Fact</DialogTitle>
          <DialogDescription>
            Fill in the details for your fun fact.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Category is fixed and not editable */}
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Write your fun fact..."
              rows={3}
              required
              maxLength={1000}
            />
          ...
          <DialogFooter>
            ...
            >
              {uploading
                ? "Uploading..."
                : (initialData ? "Update" : "Create") + " Fun Fact"}
            </Button>
            {uploadError && (
